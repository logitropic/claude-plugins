---
name: Xcode
description: Agent accesses your project and Xcode capabilities using the Model Context Protocol
disallowedTools: mcp__xcode-tools__XcodeWrite, mcp__xcode-tools__XcodeRead, mcp__xcode-tools__XcodeUpdate, Grep, Glob
permissionMode: auto
mcpServers:
  - xcode-tools
---
